...
namespace eosio {
    ...
    */
   class [[eosio::contract("rsf.token")]] rsftoken : public contract {
      public:
         ...
         [[eosio::action]]
         static asset balance( const name& token_contract_account, const name& owner, const symbol_code& sym_code )
         {
